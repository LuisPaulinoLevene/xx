...
function gerarPlano() {
    ...
    if (escola && data && nome && disciplina && classe && turma && unidadeTematica && tema && objetivosText && tempo && duracao && tipoDeAula) {
        ...
        rows[0].cells[1].innerHTML = `<div class="left-align"> -Recapitulação da aula sobre a escrita da letra ${letraEstudo}; - Apresentação do tema.</div>`;
        rows[0].cells[2].innerHTML = `<div class="left-align"> Orienta a recapitulação da aula sobre a escrita da letra ${letraEstudo}; - Apresenta o tema no quadro.</div>`;
        rows[0].cells[3].innerHTML = `<div class="left-align"> -Recapitula a aula sobre a escrita da letra ${letraEstudo}; Anota o tema.</div>`;
        ...
        rows[1].cells[2].innerHTML = `<div class="left-align">- Pergunta os alunos "Quem tem nome que começa com a letra ${letraEstudo}; - Escreve os nomes ditos que começam com letra ${letraEstudo} no quadro; Orienta os alunos a circundar a letra inicial no quadro; -Informa que a letra circunda é a letra ${letraEstudo} maiúscula; -Explica que a letra maiúscula é usada no inicio de nomes e frase; Orienta a escrita da letra ${letraEstudo} maiúscula no ar e no tampo; Orienta a cobertura do tracejado no quadro; Orienta a escrita no chão e no quadro.</div>`;
        rows[1].cells[3].innerHTML = `<div class="left-align">- Informa os nomes que começam com a letra ${letraEstudo}; - Observa a escrita dos nomes que começam com letra ${letraEstudo} no quadro; - Circunda a letra inicial no quadro; - Presta atenção na explicação; -Escreve a letra ${letraEstudo} maiúscula no ar e no tampo; -Cobre o tracejado no quadro; escreve no chão e no quadro.</div>`;
        ...
        rows[2].cells[2].innerHTML = `<div class="left-align">- Apresenta os exercícios; <br> -Orienta a resolução dos exercícios no livro do aluno;</div>`;
        rows[2].cells[3].innerHTML = `<div class="left-align">- Anota os exercícios; <br>- Resolve os exercícios no livro do aluno.</div>`;
