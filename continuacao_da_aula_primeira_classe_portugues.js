...
function gerarPlano() {
    ...
    if (escola && data && nome && disciplina && classe && turma && unidadeTematica && tema && objetivosText && tempo && duracao && tipoDeAula) {
        ...
        rows[0].cells[1].innerHTML = `<div class="left-align"> - Apresentação do tema da aula anterior.</div>`;
        rows[0].cells[2].innerHTML = `<div class="left-align"> - Apresenta o tema da aula anterior no quadro.</div>`;
        rows[0].cells[3].innerHTML = `<div class="left-align"> -Anota o tema da aula anterior.</div>`;
        ...
        if (conteudoMediacao) {
            rows[1].cells[1].innerHTML = `<div class="left-align"><strong> Continuação da aula sobre ${tema}</strong>. <br><br> Veja os conteudos na página ${conteudoMediacao} do livro do aluno.</div>`;
        } else {
            rows[1].cells[1].innerHTML = `<div class="left-align"><strong>Continuação da aula sobre ${tema}</strong>. <br><br>Apontamentos em anexo.</div>`;
        }
        rows[1].cells[2].innerHTML = `<div class="left-align">- Orienta o resumo do que foi abordado na aula anterior sobre ${tema}; -Continua orientar as actividades da aula anterior sobre ${tema}.</div>`;
        rows[1].cells[3].innerHTML = `<div class="left-align">- Resume o que foi abordado na aula anterior sobre ${tema}; Realiza as actividades previstas na aula anterior sobre ${tema}.</div>`;
        ...
        rows[3].cells[1].innerHTML = `<div class="left-align">Correção dos exercícios; <br> <br>- Marcação do TPC. <br> <br> ${conteudoControle}</div>`;
