...
function gerarPlano() {
    ...
    if (escola && data && nome && disciplina && classe && turma && unidadeTematica && tema && objetivosText && tempo && duracao && tipoDeAula) {
        ...
        rows[0].cells[2].innerHTML = `<div class="left-align">- Corrige o TPC;<br>- <br>- Passa o tema no quadro.</div>`;
        ...
        rows[0].cells[5].innerHTML = `<div class="left-align">Quadro, giz, apagador e livro do aluno e caderno</div>`;
        ...
        if (conteudoMediacao.trim() !== '') {
            ...
            rows[1].cells[2].innerHTML = `<div class="left-align">- Explora os conhecimentos do aluno sobre o tema;<br>- Orienta abrir o livro na pag. ${conteudoMediacao};<br>- Orienta a observação das imagens; <br>- Orienta a leitura e interpretação das imagens dando perguntas; <br>- Sintetiza as indeias dos alunos</div>`;
        } else {
            // Se não preenchido, exibe o conteúdo
            rows[1].cells[2].innerHTML = `<div class="left-align">- Explora os conhecimentos do aluno sobre o tema;<br>- Ilustra o cartaz no quadro;<br>- Orienta a observação do cartaz; <br>- Orienta a leitura e interpretação do cartaz dando perguntas; <br>- Sintetiza as indeias dos alunos</div>`;
        }

        // Verifica se conteudoMediacao está preenchido
        if (conteudoMediacao.trim() !== '') {
            // Se preenchido, exibe o conteúdo"
            rows[1].cells[3].innerHTML = `<div class="left-align">- Contribui pelos conhecimentos sobre o tema;<br>- Abre o livro na pag. ${conteudoMediacao};<br>- Observa as imagens na pag. ${conteudoMediacao}; <br>- Lê e interpreta as imagens da pag. ${conteudoMediacao} respondendo as perguntas; Presta atenção na sintetização das ideias.</div>`;
        } else {
            // Se não preenchido, exibe o conteúdo
            rows[1].cells[3].innerHTML = `<div class="left-align">- Contribui pelos conhecimentos sobre o tema;<br>- Observa o cartaz no quadro; <br>- Lê e interpreta o cartaz do quadro respondendo as perguntas; Presta atenção na sintetização das ideias.</div>`;
        }
        ...
        if (conteudoMediacao.trim() !== '') {
            ...
            // Se não preenchido, exibe o conteúdo
            rows[1].cells[5].innerHTML = `<div class="left-align">- Quadro, giz, apagador e cartaz</div>`;
        }
