...
function gerarPlano() {
    ...
    if (escola && data && nome && disciplina && classe && turma && unidadeTematica && tema && objetivosText && tempo && duracao && tipoDeAula && materialDidatico && letraEstudo) {
        ...
        if (conteudoMediacao.trim() !== '') {
            ...
            rows[1].cells[2].innerHTML = `<div class="left-align">- Orienta a recapitulação das vogais ja aprendidas; - Ilustra o quadro silabico no quadro; - Orienta o preenchimento do quadro silabico; - Orienta a leitura das silabas formadas em: coro, em grupos e individualmente.</div>`;
        } else {
        ...
        if (conteudoMediacao.trim() !== '') {
            // Se preenchido, exibe o conteúdo"
            rows[1].cells[3].innerHTML = `<div class="left-align">- Recapitula as vogais ja aprendidas; - Observa o quadro silabico no quadro; - preenche o quadro silabico com ajuda do professor; - lê as silabas formadas em: coro, em grupos e individualmente.</div>`;
        } else {
            // Se não preenchido, exibe o conteúdo
            rows[1].cells[3].innerHTML = `<div class="left-align">- Recapitula as vogais ja aprendidas; - Observa o quadro silabico no quadro; - preenche o quadro silabico com ajuda do professor; - lê as silabas formadas em: coro, em grupos e individualmente.</div>`;
        }
